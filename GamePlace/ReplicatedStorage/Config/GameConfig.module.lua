...
local GameConfig = {
    ...
    SpawnZones = {
        ...
        SpawnZone1  = { Weight = 65, SpawnInterval = 3,  MaxPieces = 40, PieceLifetime = 90, RarityWeights = { Common = 1.0, Rare = 0.0, Epic = 0.0, Legendary = 0.0 }, KillWall = { Enabled = true,  SpeedRange = {5, 12},    HeightRange = {3,  6},  WallWidth = 5, InnerRadius = nil, OuterRadius = nil, SweepAngle = 180, StartAngle = -90 } },
